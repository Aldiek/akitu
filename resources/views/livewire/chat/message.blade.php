                    ...
                    <div class="card-body chatbox p-0">
                        <ul class="list-group list-group-flush" wire:poll="render">
                            @foreach($users as $user)
                                ...
                                @endphp
                                <a href="{{ route('chat.inbox.show', $user->id) }}" class="text-dark link">
                                ...
                                <a href="{{ route('task.time', $user->id) }}" class="btn btn-block btn-warning">Add Time To {{ $user->name }}</a>
                    ...
                    <div class="card-body message-box">
                        ...
                        @else
                            ...
                            @else
                                No messages to show
                            @endif
                            @if(!isset($clicked_user) and auth()->user()->utype === 'ADM')
